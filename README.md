...
# Architecture
Simple C++ backend REST HTTP server, built using [cpp-httplib](https://github.com/yhirose/cpp-httplib/tree/master), able to be interfaced with a variety of clients. Currently implemented clients include a Python CLI.
